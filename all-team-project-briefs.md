...
|AI<br>알고리듬,<br>모듈 등<br>리스트|1. 차량 번호판 인식<br>a. YOLO: 차랑 번호판 영역 검출<br>b. k-NN: 차량 번호판 숫자 인식<br>c. 템플릿 매칭: 차량 번호판 문자 인식<br>2. 불법주정차 탐지 및 추출<br>a. YOLO<br>b.OpenCV<br>3. 불법주정차 분류<br>a.CNN/ResNet 등 - 여러 알고리즘 중 정확도 높은 알고리즘 채택|
