...
|만들고자 하는 것|분실물 정보를 사용자로부터 키워드와 프롬프트로 입력받아 분실물의 몽타주를 생성하는 웹 서비스입니다. <br>Text-to-Image 모델(Dall-E)을 사용하여 몽타주를 생성하고 사용자가 살펴봐야 할 정보를 시각화하여 제공합니다.<br>이때, 사용자는 필터링 된 정보를 제공받음으로써 분실물을 찾는 과정이나 웹 서핑 피로도가 감소한다는 기대효과가 있습니다.|
