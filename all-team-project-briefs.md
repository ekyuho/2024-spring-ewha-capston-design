...
|[21](#team-21)|반려코더스| 비슷한 체형과 스타일을 가진 세터와 시커를 매치한 후, 시커가 아이템을 고르면 AI모델이 특정 아이템에 대한 리뷰를 분석하여 코디 후보를 제공하고, 세터가 그 중 셀렉하여 시커에게 코디 어드바이스를 해주는 소통형 AI 플랫폼                                                                                       |
...
|:---|:---|
|팀명|반려코더스|
|프로젝트명|<H3>비슷한 체형과 스타일을 가진 세터와 시커를 매치한 후, 시커가 아이템을 고르면 AI모델이 특정 아이템에 대한 리뷰를 분석하여 코디 후보를 제공하고, 세터가 그 중 셀렉하여 시커에게 코디 어드바이스를 해주는 소통형 AI 플랫폼 </H3>|
|서비스명||비대면으로 만나볼 수 있는 나만의 스타일리스트
