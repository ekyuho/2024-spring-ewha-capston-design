...
|Big Data<br>AI 전략|1. 데이터 수집 및 관리: <br>
    - 사진이나 CCTV 영상과 같은 이미지 데이터를 수집하고 관리한다. 실종된 노인 및 아동의 사진을 중심으로 데이터를 구성한다.<br>
    - 클라우드 기술을 활용하여 대량의 이미지 데이터를 안정적으로 저장하고 관리한다.<br>
2. YOLO 딥러닝 알고리즘을 활용한 객체 인식: <br>
    - YOLO 딥러닝 알고리즘을 사용하여 이미지나 CCTV 영상에서 실종된 노인 및 아동을 식별한다. <br>
    - 객체 인식 기술을 통해 노인과 아동의 얼굴 뿐만 아니라 다양한 특징을 식별하고 추적한다. <br>
3. 이동 패턴 및 행동 분석: <br>
    - 추적된 노인과 아동의 이동 패턴 및 행동을 분석합니다. 이를 통해 실종자의 현재 위치를 예측하고 파악한다.<br>
    - YOLO 알고리즘을 통해 추출된 정보를 활용하여 이동 경로를 추적하고 행동을 분석한다.<br>
4. 실시간 위치 반환 시스템:<br>
    - 클라우드 기술을 활용하여 실시간 위치 반환 시스템을 구축한다. 이를 통해 관련 경찰 당국 및 실종자 가족에게 빠르게 알릴 수 있다.<br>
    - YOLO 알고리즘을 통해 추적된 정보를 실시간으로 분석하여 대응 전략을 개발하고 실행한다.<br>
<br>
이러한 전략과 기술적 성과를 통해 실종된 노인 및 아동의 위치를 신속하게 추적하고 파악하는 서비스를 구축할 수 있다. 이는 노인과 아동의 안전을 보장하고 사회적 문제를 해결하는 데 중요한 역할을 할 수 있다. |
|기대성과|1. 신속한 대응 및 조치: 클라우드와 딥러닝 알고리즘을 활용하여 현재 위치를 추적하고 실종자를 신속하게 발견하고 안전한 장소로 이동시킬 수 있다.<br>
2. 정확한 위치 정보 제공: CCTV 카메라를 통해 실종자의 이동 경로를 정확하게 파악하고 현재 위치를 파악할 수 있으며, 이는 효율적인 수사와 대응에 도움이 된다.<br>
3. 협력과 조정 강화: 수집된 정보를 기반으로 경찰은 다른 기관과 협력하여 실종자 수색 및 구조 작업을 효율적으로 수행할 수 있다.<br>
...
- 실종자 정보|
|AI<br>알고리듬,<br>모듈 등<br>리스트|- YOLO - CCTV에서 객체 탐지 및 개인 특정<br>
- CNN 기반의 Siamese Network - 이미지 특징 추출 및 비교를 통한 개인 식별<br>
