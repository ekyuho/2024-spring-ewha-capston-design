...
|Big Data<br>AI 전략|사용자가 직접 작성한 필기 자료 데이터, 사용자가 복습하고 싶은 외부 자료 데이터, AI가 생성한 퀴즈 내용에 대한 데이터, 사용자의 퀴즈 결과 데이터가 축적되어 있다.<br>이러한 데이터를 통해 사용자는 자신이 복습하고 싶은 내용을 복습 퀴즈를 통해 공부할 수 있으며 자주 틀리는 문항에 대한 데이터로 보다 효율적인 학습을 할 수 있고 사용자는 자신이 가지고 있는 자료들을 다른 이와 나눌 수 있어 정보 공유를 자유롭게 할 수 있을 것입니다.<br>따라서 고도화되는 시대에서 원활하게 진행되는 정보 공유에 발맞추어 자신이 지니고 있는 가치를 나누게 되는 부가가치를 누릴 수 있을 것이며, 바쁜 현대 사회 속에서도 지식을 함양할 수 있을 것입니다.|
|기대성과|사용자가 자신이 정리한 필기 자료를 편리하게 찾아볼 수 있으며 필기 자료를 바탕으로 생성된 퀴즈를 통해 사용자는 복습을 원활하게 할 수 있을 것 이다. 또한, 사용자는 자신이 틀렸던 퀴즈를 다시 확인할 수 있으며 사용자는 퀴즈 결과에 대한 분석자료도 제공받을 수 있다. 다른 이가 기록한 정리본도 공유받을 수 있고 자신이 기록한 정리본도 공유할 수 있다.|
