...
|오픈소스<br>리스트<br>명칭과 URL|허니비 - 이미지 캡셔닝(https://github.com/kakaobrain/honeybee)<br>DALL·E (openAI)([https://platform.openai.com/docs/guides/images?context=node](https://platform.openai.com/docs/guides/images?context=nodeGPT4))<br>GPT4 (openAI)(https://platform.openai.com/docs/guides/text-generation)<br>Whisper(openAI)(https://platform.openai.com/docs/guides/speech-to-text)|
|AI<br>알고리듬,<br>모듈 등<br>리스트||
