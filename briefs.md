...
|[13](#team-13)|AI:D|이화여대 학생 맞춤 공지 알림 & 캘린더: CloudMind|
...
|오픈소스<br>리스트<br>명칭과 URL|1 1) 실시간 음성→자막 변환 기능 (https://cloud.google.com/speech-to-text/docs/transcribe-streaming-audio?hl=ko#perform_streaming_speech_recognition_on_an_audio_stream)
2) 수화 모션→한국어 번역 기능 (https://github.com/23bulgogi/sonmari?tab=readme-ov-file)
3) 얼굴 인식해 표정 분석하는 기능 (https://github.com/23bulgogi/sonmari?tab=readme-ov-file)
4) 가상 목소리 생성 API (https://cloud.google.com/text-to-speech?hl=ko)|
...
|Team<br>Ground<br>Rule|03 이대뎅김[Click to See](https://github.com/IDaeDengGim/GroundRule/blob/main/GroundRule.md)|
  ...
  [Return Top](#전체-프로젝트-리스트)
## Team 4
# knowledge distillation을 통한 CLIP(멀티모달 모델) 가속화
|항목|내용|
|:---|:---|
|팀명|티라노|
...
|오픈소스<br>리스트<br>명칭과 URL|4 1. PyTorch: https://pytorch.org/
2. TensorFlow: https://www.tensorflow.org/
3. Hugging Face Transformers: https://huggingface.co/transformers/
4. OpenAI CLIP: https://openai.com/clip/|
...
|Team<br>Ground<br>Rule|04 티라노[Click to See](https://github.com/sudaltokki/Tyrano_CLIP/blob/main/ground_rule.pdf)|
  ...
  [Return Top](#전체-프로젝트-리스트)
## Team 5
# mediapipe기반 동화 속 등장인물과의 의사소통을 통한 아이들의 사회성 발달 웹/앱
|항목|내용|
|:---|:---|
|팀명|그린나래|
...
|오픈소스<br>리스트<br>명칭과 URL|5 [Frontend]
...
|Team<br>Ground<br>Rule|05 그린나래[Click to See](https://github.com/EWHA-DraWings/Submit/blob/main/GroundRule.md)|
  ...
  [Return Top](#전체-프로젝트-리스트)
## Team 6
# 과외하고 있는 선생님을 위한 머신러닝 기반 학습 관리 보고서 제작 프로그램
|항목|내용|
|:---|:---|
|팀명|머스캣|
...
|오픈소스<br>리스트<br>명칭과 URL|6 - TensorFlow 2.16.1: https://www.tensorflow.org/
- PyTorch 2.2: https://pytorch.org/|
|AI<br>알고리듬,<br>모듈 등<br>리스트|GPT-4 모델: https://openai.com/research/gpt-4|
|Team<br>Ground<br>Rule|06 머스캣[Click to See](https://github.com/Musccat/GROUND-RULE/blob/main/README.md)|
...
|오픈소스<br>리스트<br>명칭과 URL|7 허니비 - https://github.com/kakaobrain/honeybee
...
|오픈소스<br>리스트<br>명칭과 URL|9 - Pytorch : https://pytorch.org/
- openCV : https://opencv.org/
- github : https://github.com/
- React : https://ko.legacy.reactjs.org/
- MySQL : https://www.mysql.com/
- JetBrains-Intellij : https://www.jetbrains.com/ko-kr/opensource/idea/
- google cloud vision AI : https://cloud.google.com/vision?hl=ko|
...
|오픈소스<br>리스트<br>명칭과 URL|10 react-query(https://tanstack.com/query/latest/docs/framework/react/overview)
...
|Team<br>Ground<br>Rule|10. 하면함[Click to See](https://github.com/HA-MYUN-HAM/.github/blob/main/GROUND_RULE.md)|
  ...
  [Return Top](#전체-프로젝트-리스트)
## Team 11
# 한국에 체류하는 외국인들에게 dietary restriction에 따른 음식 선택에 도움을 제공할 수 있는 앱서비스
|항목|내용|
|:---|:---|
|팀명|힘찬유니콘|
...
|오픈소스<br>리스트<br>명칭과 URL|11 음식(한식) 사진 데이터셋 (https://aihub.or.kr/aihubdata/data/view.do?currMenu=115&topMenu=100&dataSetSn=79)
레시피 데이터 (https://www.data.go.kr/data/15081026/openapi.do?recommendDataYn=Y#/tab_layer_recommend_data)
지도 API (https://navermaps.github.io/maps.js.ncp/)
|
...
|Team<br>Ground<br>Rule|11 힘찬유니콘[Click to See](https://github.com/Powerful-Unicorn/.github/blob/main/ground_rule.md)|
  ...
  [Return Top](#전체-프로젝트-리스트)
## Team 12
# 가게 리모델링 및 인테리어에 어려움을 겪고 있는 소상공인을 위한 AI와 컴퓨터 그래픽스를 사용한 공간 모델링 웹 서비스
|항목|내용|
|:---|:---|
|팀명|쿨라피|
...
|오픈소스<br>리스트<br>명칭과 URL|12 Node.js: https://nodejs.org/en
MySQL: https://www.mysql.com/
...
|Team<br>Ground<br>Rule|12 쿨라피[Click to See](https://github.com/Coollaafi/Coollaafi_Frontend/blob/main/ground.md)|
  ...
  [Return Top](#전체-프로젝트-리스트)
## Team 13
# 이화여대 학생 맞춤 공지 알림 & 캘린더: CloudMind
|항목|내용|
|:---|:---|
|팀명|AI:D|
...
|오픈소스<br>리스트<br>명칭과 URL|13 전체 공지사항: https://www.ewha.ac.kr/ewha/news/notice.do
학과 공지사항: https://cse.ewha.ac.kr/cse/student/notice.do|
...
|Team<br>Ground<br>Rule|13 AI:D[Click to See](https://github.com/sohvun/2024AID/blob/main/team-ground-rule.md)|
  ...
  [Return Top](#전체-프로젝트-리스트)
## Team 15
# 뮤딩 : 독자들이 글에 쉽게 몰입할 수있게 도와주는 텍스트 기반 음악 생성 AI 서비스
|항목|내용|
|:---|:---|
|팀명|와일드 가오리|
...
|오픈소스<br>리스트<br>명칭과 URL|15 GPT4All (MIT) : https://github.com/nomic-ai/gpt4all
LlaMA-Factory (Apache-2.0) : https://github.com/hiyouga/LLaMA-Factory|
...
|Team<br>Ground<br>Rule|15 와일드 가오리[Click to See](https://github.com/Wild-Gaori/wildgaori-start/blob/main/ground-rule.md)|
  ...
  [Return Top](#전체-프로젝트-리스트)
## Team 16
# 사용자의 필기를 통해 AI 기반 퀴즈를 자동 생성하여 사용자의 복습을 돕는 웹/앱 서비스
|항목|내용|
|:---|:---|
|팀명|불사신|
...
|오픈소스<br>리스트<br>명칭과 URL|16 chat gpt, tensorflow
...
|오픈소스<br>리스트<br>명칭과 URL|17 |
|AI<br>알고리듬,<br>모듈 등<br>리스트||
|Team<br>Ground<br>Rule|17 포카리[Click to See](https://github.com/monimoni12/2024-spring-ewha-capston-design/blob/main/TeamGround.md)|
...
|오픈소스<br>리스트<br>명칭과 URL|18 유니티 에셋 :  https://assetstore.unity.com/ko-KR
...
|오픈소스<br>리스트<br>명칭과 URL|19 YOLOv5 GitHub: https://github.com/ultralytics/yolov5
...
|오픈소스<br>리스트<br>명칭과 URL|20 안드로이드 스튜디오: https://developer.android.com/?hl=ko
...
|오픈소스<br>리스트<br>명칭과 URL|21 Weather API
...
|Team<br>Ground<br>Rule|21 반려코더스[Click to See](https://github.com/chaechaeis/capstoneProject/blob/main/groundRule.md)|
  ...
  [Return Top](#전체-프로젝트-리스트)
## Team 23
# 고화질 실사 이미지 생성을 위해 멀티모달 데이터 처리 기술을 활용한 Stable Diffusion 모델 최적화
|항목|내용|
|:---|:---|
|팀명|이화도인지|
...
|오픈소스<br>리스트<br>명칭과 URL|23 GAN (https://github.com/eriklindernoren/Keras-GAN/tree/master/gan)
